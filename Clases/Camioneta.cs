...
namespace Clases
{
    ...
    {
        public Camioneta(long Codigo,string Nombre, float CantidadCombustible, float CapacidadTanque
            , float DistanciaRecorrida, string Color, float VelocidadMaxima, Sistema Sistema)
        {
            this.Codigo = Codigo;
            this.Nombre = Nombre;
